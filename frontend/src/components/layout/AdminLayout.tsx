...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const [notifications] = useState([
    ...
    { id: 2, message: '3 participants registered', time: '1 hour ago', read: false },
          ...
          {navItems.map((item) => (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                border: isActive ? '1px solid rgba(41,121,255,0.15)' : '1px solid transparent',
                ...
                <div style={{
                  ...
                  {notifications.map((notif) => (
                    <div key={notif.id} style={{
                      padding: '10px 12px',
                      borderRadius: '10px',
                      background: notif.read ? 'transparent' : 'rgba(41,121,255,0.05)',
                      marginBottom: '2px',
