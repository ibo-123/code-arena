...
const sizeMap = {
  sm: { padding: "2px 10px", fontSize: "10px", borderRadius: "12px", gap: "4px" },
  md: { padding: "4px 14px", fontSize: "12px", borderRadius: "100px", gap: "6px" },
  lg: { padding: "6px 18px", fontSize: "14px", borderRadius: "100px", gap: "8px" },
} as const;
