    ...
    tournamentApi
      ...
      .then(({ participants }) => {
        const p = participants.find(
          (item) => item._id === participantId || item.user._id === participantId,
        );
    ...
    <>
      ...
      <main className="page public-page">
        <div style={{ marginBottom: 16 }}>
          <Link
            to="/leaderboard"
            style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "var(--sub)" }}
          >
        ...
        <div className="stat-grid">
          <Card>
            ...
            <strong className="stat-value">
              {participant.group ? `Group ${participant.group}` : "Unassigned"}
            </strong>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <strong className="stat-value">{participant.currentStage || "Group Stage"}</strong>
          </Card>
        </div>
        ...
        <div className="two-col" style={{ marginTop: 16 }}>
          <Card>
            ...
            <strong className="stat-value" style={{ color: "var(--purple)" }}>
